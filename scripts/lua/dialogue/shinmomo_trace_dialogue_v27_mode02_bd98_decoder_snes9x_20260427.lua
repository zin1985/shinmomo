-- shinmomo_trace_dialogue_v27_mode02_bd98_decoder_snes9x_20260427.lua
-- v27: C0:BD98 mode02 bitstream decoder 実装版
--
-- 目的:
...
logLine("shinmomo dialogue v27 mode02 BD98 decoder loaded.")
...
logLine("TRACE_DIALOGUE_V27_READY,frame=" .. emu.framecount() .. "," .. state())
